<script setup>
    ...
    import MenuItem from '../components/CatalogItem.vue';
...
<template>
    ...
    <main class="container mx-auto w-11/12 md:w-full py-20">
        ...
        <div class="grid grid-cols-2 gap-2 md:gap-8 lg:grid-cols-3 mt-8 mx-auto">
            <MenuItem 
