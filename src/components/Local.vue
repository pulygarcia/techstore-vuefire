...
<template>
    <main class="py-20" id="local">
        <div class="container mx-auto w-11/12 md:w-full md:grid md:grid-cols-5 gap-8 md:items-center">
            ...
            <div class="flex flex-col gap-4 col-span-2 mt-5 md:mt-0">
                <img src="https://img.freepik.com/fotos-premium/samsung-galaxy-s6-exhibicion-tienda-apple-bangkok_1308172-77220.jpg" alt="" class="rounded-lg">
                <img src="https://www.dominion-global.com/files/images/media/Tienda_PHONE_HOUSE_con_nuevo_concepto.jpg" alt="" class="rounded-lg">
            </div>
        </div>
    </main>
</template>